...
return new class extends Migration
{
    ...
    {
        Schema::create('register_estate_items', function (Blueprint $table) {
            $table->id();
            $table->foreignId('register_estate_id')->references('id')->on('register_estates');
            $table->foreignId('register_estate_field_id')->references('id')->on('register_estate_fields');
    ...
    {
        Schema::dropIfExists('register_estate_items');
    }
};
